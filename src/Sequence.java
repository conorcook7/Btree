...
/**
 * This is a treeObject class that contains the 
 * key sequence and keeps track of the amount of
 * duplicates there are per Sequence
 * 
...
public class Sequence {
	...
	/**
	 * Simple getter method that gets the duplicate amount
	...
	/**
	 * This method overrides the existing toString 
	 * to a new and improved version :)
	 */
